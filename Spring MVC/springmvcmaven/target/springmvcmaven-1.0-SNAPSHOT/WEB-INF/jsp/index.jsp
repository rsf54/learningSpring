...
<header id="home" class="header">
    <nav class="nav" role="navigation">
        <div class="container nav-elements">
            <div class="branding">
                <a href="#home"><img src="../../../resources/images/hpluslogo.svg" alt="Logo - H Plus Sports"></a>
            </div><!-- branding -->
            <ul class="navbar">
    ...
    <div class="container">
        ...
        <div class="people-cards">
            <div class="person-card">
                <img src="../../../resources/images/employees/HenryTwill.jpg" alt="HenryTwill Photo">
                <div class="card-info">
            ...
            <div class="person-card">
                <img src="../../../resources/images/employees/JessicaNewton.jpg" alt="JessicaNewton Photo">
                <div class="card-info">
            ...
            <div class="person-card">
                <img src="../../../resources/images/employees/PhiTang.jpg" alt="PhiTang Photo">
                <div class="card-info">
            ...
            <div class="person-card">
                <img src="../../../resources/images/employees/MariaSontas.jpg" alt="MariaSontas Photo">
                <div class="card-info">
            ...
            <div class="person-card">
                <img src="../../../resources/images/employees/AngelaHaston.jpg" alt="AngelaHaston Photo">
                <div class="card-info">
            ...
            <div class="person-card">
                <img src="../../../resources/images/employees/MichaelLewiston.jpg" alt="MichaelLewiston Photo">
                <div class="card-info">
